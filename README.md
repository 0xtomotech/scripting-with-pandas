# Scripting with Pandas - Pandas

A comprehensive tutorial on the Python Pandas library.

The tutorial can be found [here](https://youtu.be/2uvysYbKdjM?si=8UnGt0bwLwo-eEQL)

The main file usedh in the tutorial is [main-script.ipynb](./main-script.ipynb)

### Credit

This project is based on [complete-pandas-tutorial](https://github.com/KeithGalli/complete-pandas-tutorial).
